...
#define CONVERT_COLOR_TO_ARGB(c) (SDL_Swap32LE(c))
#define CONVERT_COLOR_TO_ABGR(c) ((SDL_Swap32BE(c) & 0xFFFFFF00)  >> 8 | (SDL_Swap32LE(c) & 0xFF000000))
#else
...
#ifdef PERIMETER_SDL3
    inline void ARGB(uint32_t argb)                 { v = SDL_Swap32LE(argb); }
#else
