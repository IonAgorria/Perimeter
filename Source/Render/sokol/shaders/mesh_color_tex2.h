...
/*
    ...
    Bindings:
        ...
        Image 'un_tex1':
            ...
            Sample type: SG_IMAGESAMPLETYPE_FLOAT
            Multisampled: false
            Bind slot: IMG_mesh_color_tex2_un_tex1 => 4
        Sampler 'un_sampler0':
...
#define IMG_mesh_color_tex2_un_tex1 (4)
...
static inline const sg_shader_desc* mesh_color_tex2_program_shader_desc(sg_backend backend) {
    ...
    if (backend == SG_BACKEND_GLCORE) {
        ...
        if (!valid) {
            ...
            desc.image_sampler_pairs[1].image_slot = 4;
    ...
    if (backend == SG_BACKEND_D3D11) {
        ...
        if (!valid) {
            ...
            desc.images[4].sample_type = SG_IMAGESAMPLETYPE_FLOAT;
            desc.images[4].multisampled = false;
            desc.images[4].hlsl_register_t_n = 1;
            desc.samplers[2].stage = SG_SHADERSTAGE_FRAGMENT;
            desc.samplers[2].sampler_type = SG_SAMPLERTYPE_FILTERING;
