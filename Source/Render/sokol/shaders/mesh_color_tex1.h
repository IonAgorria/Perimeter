...
/*
    ...
    Shader program: 'program':
        ...
        Fragment Shader: fs
        Attributes:
            ATTR_mesh_color_tex1_program_vs_position => 0
            ATTR_mesh_color_tex1_program_vs_color => 1
            ATTR_mesh_color_tex1_program_vs_texcoord0 => 2
    Bindings:
        Uniform block 'mesh_color_texture_vs_params':
            C struct: mesh_color_tex1_mesh_color_texture_vs_params_t
            Bind slot: UB_mesh_color_tex1_mesh_color_texture_vs_params => 0
        Uniform block 'mesh_color_texture_fs_params':
            C struct: mesh_color_tex1_mesh_color_texture_fs_params_t
            Bind slot: UB_mesh_color_tex1_mesh_color_texture_fs_params => 1
        Image 'un_tex0':
            Image type: SG_IMAGETYPE_2D
            Sample type: SG_IMAGESAMPLETYPE_FLOAT
            Multisampled: false
            Bind slot: IMG_mesh_color_tex1_un_tex0 => 3
        Sampler 'un_sampler0':
            Type: SG_SAMPLERTYPE_FILTERING
            Bind slot: SMP_mesh_color_tex1_un_sampler0 => 2
*/
...
#endif
#endif
#define ATTR_mesh_color_tex1_program_vs_position (0)
#define ATTR_mesh_color_tex1_program_vs_color (1)
#define ATTR_mesh_color_tex1_program_vs_texcoord0 (2)
#define UB_mesh_color_tex1_mesh_color_texture_vs_params (0)
#define UB_mesh_color_tex1_mesh_color_texture_fs_params (1)
#define IMG_mesh_color_tex1_un_tex0 (3)
#define SMP_mesh_color_tex1_un_sampler0 (2)
#pragma pack(push,1)
...
static inline const sg_shader_desc* mesh_color_tex1_program_shader_desc(sg_backend backend) {
    ...
    if (backend == SG_BACKEND_GLCORE) {
        ...
        if (!valid) {
            valid = true;
            desc.vertex_func.source = (const char*)mesh_color_tex1_vs_source_glsl410;
            desc.vertex_func.entry = "main";
            desc.fragment_func.source = (const char*)mesh_color_tex1_fs_source_glsl410;
    ...
    if (backend == SG_BACKEND_GLES3) {
        ...
        if (!valid) {
            valid = true;
            desc.vertex_func.source = (const char*)mesh_color_tex1_vs_source_glsl300es;
            desc.vertex_func.entry = "main";
            desc.fragment_func.source = (const char*)mesh_color_tex1_fs_source_glsl300es;
            desc.fragment_func.entry = "main";
            desc.attrs[0].base_type = SG_SHADERATTRBASETYPE_FLOAT;
            desc.attrs[0].glsl_name = "vs_position";
            desc.attrs[1].base_type = SG_SHADERATTRBASETYPE_FLOAT;
    ...
    if (backend == SG_BACKEND_D3D11) {
        ...
        if (!valid) {
            valid = true;
            desc.vertex_func.source = (const char*)mesh_color_tex1_vs_source_hlsl5;
            desc.vertex_func.d3d11_target = "vs_5_0";
            desc.vertex_func.entry = "main";
            desc.fragment_func.source = (const char*)mesh_color_tex1_fs_source_hlsl5;
    ...
    if (backend == SG_BACKEND_METAL_MACOS) {
        ...
        if (!valid) {
            valid = true;
            desc.vertex_func.source = (const char*)mesh_color_tex1_vs_source_metal_macos;
            desc.vertex_func.entry = "main0";
            desc.fragment_func.source = (const char*)mesh_color_tex1_fs_source_metal_macos;
    ...
    if (backend == SG_BACKEND_METAL_IOS) {
        ...
        if (!valid) {
            valid = true;
            desc.vertex_func.source = (const char*)mesh_color_tex1_vs_source_metal_ios;
            desc.vertex_func.entry = "main0";
            desc.fragment_func.source = (const char*)mesh_color_tex1_fs_source_metal_ios;
            desc.fragment_func.entry = "main0";
            desc.attrs[0].base_type = SG_SHADERATTRBASETYPE_FLOAT;
            desc.attrs[1].base_type = SG_SHADERATTRBASETYPE_FLOAT;
            desc.attrs[2].base_type = SG_SHADERATTRBASETYPE_FLOAT;
    ...
    if (backend == SG_BACKEND_METAL_SIMULATOR) {
        ...
        if (!valid) {
            valid = true;
            desc.vertex_func.source = (const char*)mesh_color_tex1_vs_source_metal_sim;
            desc.vertex_func.entry = "main0";
            desc.fragment_func.source = (const char*)mesh_color_tex1_fs_source_metal_sim;
            desc.fragment_func.entry = "main0";
            desc.attrs[0].base_type = SG_SHADERATTRBASETYPE_FLOAT;
            desc.attrs[1].base_type = SG_SHADERATTRBASETYPE_FLOAT;
            desc.attrs[2].base_type = SG_SHADERATTRBASETYPE_FLOAT;
...
static inline int mesh_color_tex1_program_image_slot(const char* img_name) {
    (void)img_name;
...
static inline int mesh_color_tex1_program_sampler_slot(const char* smp_name) {
    (void)smp_name;
...
static inline int mesh_color_tex1_program_uniformblock_slot(const char* ub_name) {
    (void)ub_name;
...
static inline size_t mesh_color_tex1_program_uniformblock_size(const char* ub_name) {
    (void)ub_name;
    if (0 == strcmp(ub_name, "mesh_color_texture_vs_params")) {
...
static inline int mesh_color_tex1_program_uniform_offset(const char* ub_name, const char* u_name) {
...
static inline sg_glsl_shader_uniform mesh_color_tex1_program_uniform_desc(const char* ub_name, const char* u_name) {
    (void)ub_name; (void)u_name;
...
static inline int mesh_color_tex1_program_storagebuffer_slot(const char* sbuf_name) {
    (void)sbuf_name;
    return -1;
}
static inline int mesh_color_tex1_program_storageimage_slot(const char* simg_name) {
    (void)simg_name;
    return -1;
}
