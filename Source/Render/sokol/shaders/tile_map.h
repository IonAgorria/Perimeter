...
/*
    ...
    Bindings:
        ...
        Image 'un_tex0':
            ...
            Multisampled: false
            Bind slot: IMG_tile_map_un_tex0 => 4
        Image 'un_tex1':
            Image type: SG_IMAGETYPE_2D
        ...
        Sampler 'un_sampler1':
            ...
            Bind slot: SMP_tile_map_un_sampler1 => 3
        Sampler 'un_sampler0':
...
#define IMG_tile_map_un_tex0 (4)
#define IMG_tile_map_un_tex1 (5)
#define IMG_tile_map_un_tex2 (6)
#define SMP_tile_map_un_sampler1 (3)
...
static inline const sg_shader_desc* tile_map_program_shader_desc(sg_backend backend) {
    ...
    if (backend == SG_BACKEND_GLCORE) {
        ...
        if (!valid) {
            ...
            desc.images[4].sample_type = SG_IMAGESAMPLETYPE_DEPTH;
            ...
            desc.image_sampler_pairs[0].image_slot = 4;
    ...
    if (backend == SG_BACKEND_D3D11) {
        ...
        if (!valid) {
            ...
            desc.images[4].sample_type = SG_IMAGESAMPLETYPE_DEPTH;
            desc.images[4].multisampled = false;
            desc.images[4].hlsl_register_t_n = 0;
            desc.images[5].stage = SG_SHADERSTAGE_FRAGMENT;
            desc.images[5].image_type = SG_IMAGETYPE_2D;
            desc.images[5].sample_type = SG_IMAGESAMPLETYPE_FLOAT;
            desc.images[5].multisampled = false;
